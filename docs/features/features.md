...
* **LINEスタンプ用画像準備:** 変換済みアイコンに「おはよう」「おやすみ」等の文言を重ね、LINEクリエイターズスタンプ申請用の画像をLINE仕様で書き出し・ZIPダウンロードする機能。単語・セット・カテゴリでプリセットを選択可能。詳細は [LINEスタンプ作成機能 仕様書](./line-stamp-spec.md) を参照。
